do
    ...
    _G.Color = Color3.fromRGB(61, 245, 20)
    ...
    coroutine.resume(
      coroutine.create(
        ...
        Circle.ZIndex = 10
        Circle.Image = "rbxassetid://17717255423"
    ...
    Title.Text = "Corn hub ".."<font color='rgb(61, 245, 20)'>Comback </font>".."- "..game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name
    Title.RichText = true;
